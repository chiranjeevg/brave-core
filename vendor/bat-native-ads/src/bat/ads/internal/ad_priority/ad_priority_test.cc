...
class BatAdsAdPriorityTest : public UnitTestBase {
 protected:
  ...
  CreativeAdNotificationInfo BuildCreativeAdNotification() {
    ...
    creative_ad.creative_instance_id = base::GUID::GenerateRandomV4();
    creative_ad.creative_set_id = base::GUID::GenerateRandomV4();
    creative_ad.campaign_id = base::GUID::GenerateRandomV4();
    creative_ad.start_at = DistantPast();
    creative_ad.end_at = DistantFuture();
    creative_ad.daily_cap = 1;
    creative_ad.advertiser_id = base::GUID::GenerateRandomV4();
